    ...
    def train(self):
        ...
        for epoch in range(1, epochs + 1):
            ...
            if self.cfg["testing"] and (
                ...
                self.run.log(
                    {"avg_test_reward/MEAN_agent": agent_results[0]}, commit=False
                )
                self.run.log(
                    {"avg_test_reward/STD_agent": agent_results[1]}, commit=False
                )
                self.run.log(
                    {"avg_test_reward/MEAN_expert": expert_results[0]}, commit=False
                )
                self.run.log(
                    {"avg_test_reward/STD_expert": expert_results[1]}, commit=False
                )
